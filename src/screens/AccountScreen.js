    ...
    <View style={styles.container}>
      ...
      <View style={styles.profileHeaderContainer}>
        ...
        <View style={styles.profileTextContainer}>
          <Text style={styles.nameText}>Chairil Ashar</Text>
          <Text style={styles.emailText}>asharchairil@gmail.com</Text>
        </View>
      </View>
      <View style={styles.menuContainer}>
        ...
        <TouchableOpacity style={styles.menuItem} activeOpacity={0.8}>
          ...
          <Text style={styles.menuText}>Delivery Addres</Text>
        </TouchableOpacity>
      </View>
        ...
        <TouchableOpacity style={styles.sectionContainer} activeOpacity={0.8}>
          <View style={styles.sectionTextContainer}>
            <Ionicons
              ...
              color={Colors.DEFAULT_GREEN}
            />
            <Text style={styles.sectionText}>Manage Profil</Text>
          </View>
          <Feather
            name="chevron-right"
            color={Colors.DEFAULT_GREEN}
